...
public class LinemapConstructor {

	/*
	 * Purpose:To read file and store information into Array List where the index
	 * number is the line number Pre:file that contains the code Post:list which
