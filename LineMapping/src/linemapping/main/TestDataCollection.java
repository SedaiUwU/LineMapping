...
/**
 * TestDataCollection ------------------------- This class collects and
 * summarizes results from both the professor's and team's datasets. It provides
 * an overview of:
 */
public class TestDataCollection {
	public static void main(String[] args) throws Exception {
		System.out.println("DATA COLLECTION TEST\n");

		System.out.println("Prof's dataset results ");
