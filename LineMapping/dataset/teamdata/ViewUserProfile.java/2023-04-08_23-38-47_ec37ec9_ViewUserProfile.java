...
public class ViewUserProfile extends HttpServlet {
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		pw.println("<div class='tab'>" + "<table>" + "<tr><td>Profile Photo :</td><td>" + null + "</td></tr>"
				+ "<tr><td>User Name :</td><td>" + ub.getMailId() + "</td></tr>" + "<tr><td>Password :</td><td>"
				+ ub.getPWord() + "</td></tr>" + "<tr><td>First Name :</td><td>" + ub.getFName() + "</td></tr>"
