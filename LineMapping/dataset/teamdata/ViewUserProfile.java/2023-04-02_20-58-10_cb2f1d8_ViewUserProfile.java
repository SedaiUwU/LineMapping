...
//			String pWord = ck[1].getValue();
			if (!uName.equals("") || uName != null) {
				...
				pw.println("<div class='tab'>" + "<table>" + "<tr><td>Profile Photo :</td><td>" + ub.getPhoto()
						+ "</td></tr>" + "<tr><td>User Name :</td><td>" + ub.getMailId() + "</td></tr>"
						+ "<tr><td>Password :</td><td>" + ub.getPWord() + "</td></tr>" + "<tr><td>First Name :</td><td>"
						+ ub.getFName() + "</td></tr>" + "<tr><td>Last Name :</td><td>" + ub.getLName() + "</td></tr>"
						+ "<tr><td>Address :</td><td>" + ub.getAddr() + "</td></tr>" + "<tr><td>Phone No:</td><td>"
						+ ub.getPhNo() + "</td></tr>" + "<tr><td>Mail Id :</td><td>" + ub.getMailId() + "</td></tr>"
						+ "</table>" + "</div>");
